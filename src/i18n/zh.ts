...
const zh: LANG_MESSAGE = {
  ...
  updateSubscriptionsSuccess: '订阅更新成功',
  ...
  autoSyncAllBackends: '自动同步到所有后端',
  uploadSettings: '上传设置到核心',
  syncSettings: '从核心同步设置',
  syncSettingsToAllBackends: '同步设置到所有后端',
  ...
  syncSettingsToAllBackendsSuccess: '设置已同步到 {success} 个后端',
  syncSettingsToAllBackendsPartial: '设置已同步到 {success} 个后端，{failed} 个失败：{backends}',
