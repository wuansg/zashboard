...
const zhTW: LANG_MESSAGE = {
  ...
  updateSubscriptionsSuccess: '訂閱更新成功',
  ...
  autoSyncAllBackends: '自動同步到所有後端',
  uploadSettings: '上傳設定到核心',
  syncSettings: '從核心同步設定',
  syncSettingsToAllBackends: '同步設定到所有後端',
  ...
  syncSettingsToAllBackendsSuccess: '設定已同步到 {success} 個後端',
  syncSettingsToAllBackendsPartial: '設定已同步到 {success} 個後端，{failed} 個失敗：{backends}',
